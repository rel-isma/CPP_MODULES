...
/*   Updated: 2024/02/13 19:16:53 by rel-isma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Time to process a range of  " << argc - 1 << " elements with std::vector : " << std::fixed << cpu_time_used << " s" << std::endl;
    cpu_time_usedList = ((double) (endList - startList)) / CLOCKS_PER_SEC;
    std::cout << "Time to process a range of  " << argc - 1 << " elements with std::list : " << std::fixed << cpu_time_usedList << " s" << std::endl;
